...
"""for path in os.listdir("resources/Health/CNES/raw/"):
    cnesZip = ZipFile("resources/Health/CNES/raw/"+path)
    csvName = "tbEstabelecimento"+path.split(".")[0].split("_")[-1]+".csv"
    print(csvName)
    cnesZip.extract(csvName, "resources/Health/CNES/")"""
...
print(mainFrame)
mainFrame.to_csv("dadosmuybons.csv")
